...
selection=$(zenity --list --title="Edit Dot Files" --column="Dot Files" "${dotfiles[@]}" --width=600 --height=600 --window-icon="gedit" --text="Select a dot file to edit:" --ok-label="Open" --cancel-label="Cancel")
