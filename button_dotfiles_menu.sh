...
yad --title="" \
  ...
  --field="<span foreground='#00FF00'>$(printf "\uF0C5")</span>     Source pwsh profile.ps1":FBTN "pwsh -c '[System.IO.File]::AppendAllText($PROFILE.CurrentUserAllHosts, \"`n. \\\"$env:HOME/Github/dotfiles/pwsh/profile.ps1\\\"`n\") -notmatch \"`n. \\\"$env:HOME/Github/dotfiles/pwsh/profile.ps1\\\"`n\"; Write-Host \"`e[32mpwsh profile has been copied!`e[0m\"'"\
