...
yad --title="" \
  ...
  --field="<span foreground='#FFFFFF'>$(printf '\u1F4A3')</span>     Doomsday/Prepper Spin":FBTN "bash -c 'echo test'" \
  ...
  --field="<span foreground='#FFFFFF'>$(printf '\u1F43EB')</span>     Parent/Teacher Spin":FBTN "bash -c 'echo test'"
