...
yad --title="" \
  ...
  --field="<span foreground='grey'>$(printf '\u1F4A3')</span>     Doomsday/Prepper Spin":FBTN "bash -c 'echo test'" \
  ...
  --field="<span foreground='blue'>$(printf '\u1F43EB')</span>     Parent/Teacher Spin":FBTN "bash -c 'echo test'"
