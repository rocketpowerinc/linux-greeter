...
yad --title="" \
  ...
  --field="🐳     Install Docker":FBTN "bash -c 'yad --info --title=\"Install Docker\" --width=350 --height=120 --center --window-icon=dialog-warning --text=\"<span foreground=blue size=large>⚠️ Please install Docker using CTT LinUtil Script.</span>\"'" \
