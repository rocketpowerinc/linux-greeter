...
yad --title="" \
  ...
  --field="🐳     Install Docker":FBTN "bash -c 'yad --info --title=\"Install Docker\" --width=400 --height=120 --center --window-icon=dialog-warning --markup --text=\"<span foreground=\\\"yellow\\\" size=\\\"large\\\">⚠️ Please install Docker using CTT LinUtil Script.</span>\"'"\
